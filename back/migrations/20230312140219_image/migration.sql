/*
  ...
  - You are about to drop the column `image_extension` on the `Product` table. All the data in the column will be lost.
  - You are about to drop the column `image_filesize` on the `Product` table. All the data in the column will be lost.
  - You are about to drop the column `image_height` on the `Product` table. All the data in the column will be lost.
  - You are about to drop the column `image_id` on the `Product` table. All the data in the column will be lost.
  - You are about to drop the column `image_width` on the `Product` table. All the data in the column will be lost.
...
INSERT INTO "new_Product" ("author", "balance", "captionCh", "captionEn", "captionRu", "category", "createdAt", "descriptionCh", "descriptionEn", "descriptionRu", "id", "intervals", "isActive", "seller", "subCategory", "subSubCategory", "titleCh", "titleEn", "titleRu", "updatedAt") SELECT "author", "balance", "captionCh", "captionEn", "captionRu", "category", "createdAt", "descriptionCh", "descriptionEn", "descriptionRu", "id", "intervals", "isActive", "seller", "subCategory", "subSubCategory", "titleCh", "titleEn", "titleRu", "updatedAt" FROM "Product";
DROP TABLE "Product";
